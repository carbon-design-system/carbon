...
In order to get the correct token value for the notification background, you will need to apply the following in you `scss` to your themed class. For example:
