...
[code of conduct](../docs/contributing/developer-handbook.md#carbon-code-of-conduct)
...
[developer handbook](../docs/contributing/developer-handbook.md#coding-style)
...
[developer handbook](../docs/contributing/developer-handbook.md#common-tasks)
...
[developer handbook](../docs/contributing/developer-handbook.md#commit-conventions).
...
- **Development:** If coding is your thing, you can help us by contributing bug
  ...
  [Developer Handbook](../docs/contributing/developer-handbook.md) to get your
  dev environment set up, read up on our best practices and more.
...
3. **Development environment:** If you haven't already, fork and clone whichever
   ...
   [Developer Handbook](../docs/contributing/developer-handbook.md) to read up
   on our best coding practices and proper commit messages.
