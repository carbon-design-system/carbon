...
- If a question is Carbon-related, but not necessarily related to the core components, route the person to the correct Slack channel where they might receive support. [ibmproducts-pal-dev](https://ibm.enterprise.slack.com/archives/C013ZTX0N6B), [ibmproducts-pal](https://ibm.enterprise.slack.com/archives/CQGR0HC05), [carbon-angulur](https://ibm.enterprise.slack.com/archives/CBZC0LM2N), [carbon-for-cloud](https://ibm.enterprise.slack.com/archives/C0603NZDXRD)
