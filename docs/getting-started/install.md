...
Download the latest version of Bluemix Components (`6.1.2`).

* [Download .zip](https://github.ibm.com/Bluemix/bluemix-components/archive/6.1.2.zip)
* [Download tar.gz](https://github.ibm.com/Bluemix/bluemix-components/archive/6.1.2.tar.gz)
