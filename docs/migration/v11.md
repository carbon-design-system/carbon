...
- Tooltip has been split into two components:
  - Tooltip for non-interactive content
  - Toggletip for interactive content
- TooltipDefinition has been renamed to DefinitionTooltip
- TooltipIcon has been removed, use `IconButton` instead or customize with
  `Popover`

**TooltipDefinition**

This was available as `TooltipDefinition` in v10.
...
| `onMouseEnter`     | 🙋‍♂️                                      |
| `onMouseLeave`     | 🙋‍♂️                                      |
| `tooltipText`      | ⚠️ deprecated, use `definition` instead |
| `triggerClassName` | ✅                                      |
...
| v10            | Type                                                   | v11            | Type                                                      |
| :------------- | :----------------------------------------------------- | :------------- | :-------------------------------------------------------- |
| `align`        | `PropTypes.oneOf(['start', 'center', 'end'])`          | `align`        | `PropTypes.oneOf(['start', 'center', 'end'])`             |
| `children`     | `PropTypes.node`                                       | `children`     | `PropTypes.node`                                          |
| `className`    | `PropTypes.string`                                     | `className`    | `PropTypes.string`                                        |
| `direction`    | `PropTypes.oneOf(['bottom', 'top', 'left', 'bottom'])` | `direction`    | `PropTypes.oneOf(['bottom', 'top', 'left', 'bottom'])`    |
...
| `renderIcon`   | `function`                                             | `renderIcon`   | `PropTypes.oneOfType([PropTypes.func, PropTypes.object])` |
| `tooltipText`  | `PropTypes.node`                                       | `tooltipText`  | `PropTypes.node.isRequired`                               |
