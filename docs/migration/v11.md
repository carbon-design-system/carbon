...
- Subgrid supported is officially supported when using CSS Grid
...
To help with this, we added support for percent-span across breakpoints.

Specifically, each of the responsive breakpoints props support `start` and `end`
to correspond to `grid-column-start` and `grid-column-end` in CSS Grid. `offset`
will continue to work and will alias to `grid-column-start`.
...
| v10                                    | v11                                 |
| :------------------------------------- | :---------------------------------- |
| `@import '@carbon/theme/scss/themes';` | `@use '@carbon/themes';`            |
| `@import '@carbon/theme/scss/index';`  | `@use '@carbon/themes';`            |
| (alias)                                | `@use '@carbon/styles/scss/theme';` |
| (alias)                                | `@use '@carbon/react/scss/theme';`  |
...
| Filename                | v10                     | v11                                                                                                |
| ----------------------- | ----------------------- | -------------------------------------------------------------------------------------------------- |
| `scss/_mixins.scss`     |                         | Removed, use `_theme.scss` instead                                                                 |
|                         | `@mixin carbon--theme`  | Renamed to `@mixin theme`                                                                          |
| `scss/_theme-maps.scss` |                         | Removed, use `scss/_themes.scss` instead                                                           |
...
| `scss/_config.scss`     |                         | New                                                                                                |
| `scss/_theme.scss`      |                         | New                                                                                                |
| `scss/_themes.scss`     |                         | New                                                                                                |
| `scss/themes.scss`      |                         | Moved to `index.scss`                                                                              |
| `scss/index.scss`       |                         | Moved to `index.scss`                                                                              |
