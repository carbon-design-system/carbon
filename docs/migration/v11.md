...
- Your project only uses `carbon-components` ([Link](#carbon-components))
...
If your looking for migration steps for a specific package, checkout the table
below.

| Package                    | Guide                            |
| :------------------------- | :------------------------------- |
| `carbon-components`        | [Link](#carbon-components)       |
| `carbon-components-react`  | [Link](#carbon-components-react) |
| `carbon-icons`             | [Link](#carbon-icons)            |
| `@carbon/styles`           |                                  |
| `@carbon/react`            |                                  |
| `@carbon/icons`            | [Link](#carbonicons)             |
| `@carbon/icons-react`      | [Link](#carbonicons-react)       |
| `@carbon/colors`           | [Link](#carboncolors)            |
| `@carbon/elements`         | [Link](#carbonelements)          |
| `@carbon/grid`             | [Link](#carbongrid)              |
| `@carbon/layout`           | [Link](#carbonlayout)            |
| `@carbon/motion`           | [Link](#carbonmotion)            |
| `@carbon/pictograms`       | [Link](#carbonpictograms)        |
| `@carbon/pictograms-react` | [Link](#carbonpictograms-react)  |
| `@carbon/themes`           | [Link](#carbonthemes)            |
| `@carbon/type`             | [Link](#carbontype)              |
...
- [Automated] Add `@carbon/react`
  - Update all React imports to `@carbon/react`
  - Update to Dart Sass
