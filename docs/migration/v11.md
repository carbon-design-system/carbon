...
You may also want to follow one of your upgrade paths for common migration
use-cases. Checkout one of the guides below if they apply to you:
...
- [Upgrade paths](#upgrade-paths)
  - [`carbon-components`](#carbon-components)
  - [`carbon-components`, `carbon-components-react`, `carbon-icons`](#carbon-components-carbon-components-react-carbon-icons)
  - [`carbon-components`, `carbon-components-react`, `carbon-icons`, `@carbon/icons-react`](#carbon-components-carbon-components-react-carbon-icons-carbonicons-react)
- [`carbon-components`](#carbon-components-1)
...
- [`carbon-components-react`](#carbon-components-react)
  ...
  - [Changes to props](#changes-to-props)
- [`carbon-icons`](#carbon-icons)
- [`@carbon/icons`](#carbonicons)
- [`@carbon/icons-react`](#carbonicons-react)
  - [Migration](#migration)
