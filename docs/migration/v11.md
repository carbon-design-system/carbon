...
- [Update to Dart Sass](#changing-from-node-sass-to-sass)
- Update imports
  - `@use`
  - `@import`
  - Changes to `vendor`
...
Support for `node-sass` has been dropped starting in v11. The required version
of Dart Sass is `sass@>=1.33.0`.
...
| `FileUploader`              |                                                                                                                               |
| `FileUploaderButton`        | Vertical margin is no longer included by default, use `<Stack>` for vertical spacing                                          |
...
| `FormGroup`                 | The `hasMargin` prop has been removed. Margin for vertical spacing is no longer included, use `<Stack>` for vertical spacing. |
| `FormItem`                  |                                                                                                                               |
| `FormLabel`                 |                                                                                                                               |
...
- This package now [requires Dart Sass](#changing-from-node-sass-to-sass) and
  uses Sass Modules
...
- Design Tokens have been changed, however you can use the
  [compatability guide](#todo) to use v10 tokens along with v11 tokens
