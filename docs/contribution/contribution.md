...
more details on this, checkout our
[community components](./community-components.md) documentation.

### What if I want to contribute a new pattern?

Patterns are considered website documentation. For guidelines on this, checkout
our [patterns contribution](./patterns.md) doc. One thing to note: while our
contribution documentation lives in this repo, the issue and pull request for
patterns contributions would live in our
[website repo](https://github.com/carbon-design-system/carbon-website).
