...
| 7   | Guide banner        | `GuideBanner`                                           | Moving to v12 as stable.Moves to core as a stable. Post-v12, a composable api can be explored                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| 10  | Notifications panel | `NotificationsPanel`                                    | Moves to core as a stable. Post-v12, a composable redesign will be developed and delivered as preview → stable                                                                                                                                                                                                                                                                                                                                           |
| 11  | Options tile        | `OptionsTile`                                           | Good adoption. Migrating to core as **stable**.Moves to core as a stable. Post-v12, a composable api can be explored                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| 13  | Scroll gradient     | `ScrollGradient`                                        | Moves as a utility component                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| 14  | Side panel          | `SidePanel`                                             | Moves to core as a stable. Post-v12, a composable redesign will be developed                                                                                                                                                                                                                                                                                                |
