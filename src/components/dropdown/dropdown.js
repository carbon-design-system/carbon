...
class Dropdown extends mixin(createComponent, initComponentBySearch, trackBlur) {
  ...
  static get options() {
    ...
    return {
      ...
      selectorText: `.${brandPrefix}--dropdown-text`,
      selectorItem: `.${brandPrefix}--dropdown-link`,
      selectorItemSelected: `.${brandPrefix}--dropdown--selected`,
      classSelected: `${brandPrefix}--dropdown--selected`,
      classOpen: `${brandPrefix}--dropdown--open`,
      classDisabled: `${brandPrefix}--dropdown--disabled`,
