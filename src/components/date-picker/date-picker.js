...
class DatePicker extends mixin(createComponent, initComponentBySearch, handles) {
  ...
  static get options() {
    ...
    return {
      ...
      classCalendarContainer: `${brandPrefix}--date-picker__calendar`,
      classMonth: `${brandPrefix}--date-picker__month`,
      classWeekdays: `${brandPrefix}--date-picker__weekdays`,
      classDays: `${brandPrefix}--date-picker__days`,
      classWeekday: `${brandPrefix}--date-picker__weekday`,
      classDay: `${brandPrefix}--date-picker__day`,
      classFocused: `${brandPrefix}--focused`,
