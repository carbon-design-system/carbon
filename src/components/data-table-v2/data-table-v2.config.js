...
const iconBatchDelete = `
  <svg  class="${prefix}--btn__icon" width="16px" height="16px" viewBox="0 0 16 16" role="img" aria-label="Delete" alt="Delete">
...
const iconBatchSave = `
<svg  class="${prefix}--btn__icon" width="16px" height="16px" viewBox="0 0 16 16" role="img" aria-label="Save" alt="Save">
  <title>Save</title>
...
<svg class="${prefix}--btn__icon ${prefix}--batch-download" fill-rule="evenodd" height="16px" width="16px" name="download" role="img" viewBox="0 0 16 16" width="14"
