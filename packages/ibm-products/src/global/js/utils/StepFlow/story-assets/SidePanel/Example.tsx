    ...
    <>
      ...
      <StepProvider>
        <div ref={ref}>
          ...
          <StepSidePanel
            // Causes HTML nesting error, would be nice to be able to change subtitle
            // prop to be more generic element rather than wrapping in <p>
            subtitle={
              !showIntro
                ? (state: StepState) =>
          ...
          >
            {showIntro && (
              <TileGroup
                ...
                defaultSelected="standard create flow"
