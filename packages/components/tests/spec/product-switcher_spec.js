...
describe('Popup Nav', function() {
  ...
  describe('Init Component by Launch functionality', function() {
    ...
    beforeAll(function() {
      ...
      button = range.createContextualFragment(UiShellHtml).querySelector('[data-product-switcher-target]');
      productSwitcher = range.createContextualFragment(UiShellHtml).querySelector('[data-product-switcher]');
