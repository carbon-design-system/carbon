...
- [@carbon/themes](#carbonthemes)
  ...
  - [✅tag-red-background [variable]](#tag-red-background-variable)
  - [✅tag-red-color [variable]](#tag-red-color-variable)
  - [✅tag-red-hover [variable]](#tag-red-hover-variable)
  - [✅tag-magenta-background [variable]](#tag-magenta-background-variable)
  - [✅tag-magenta-color [variable]](#tag-magenta-color-variable)
  - [✅tag-magenta-hover [variable]](#tag-magenta-hover-variable)
  - [✅tag-purple-background [variable]](#tag-purple-background-variable)
  - [✅tag-purple-color [variable]](#tag-purple-color-variable)
  - [✅tag-purple-hover [variable]](#tag-purple-hover-variable)
  - [✅tag-blue-background [variable]](#tag-blue-background-variable)
  - [✅tag-blue-color [variable]](#tag-blue-color-variable)
  - [✅tag-blue-hover [variable]](#tag-blue-hover-variable)
  - [✅tag-cyan-background [variable]](#tag-cyan-background-variable)
  - [✅tag-cyan-color [variable]](#tag-cyan-color-variable)
  - [✅tag-cyan-hover [variable]](#tag-cyan-hover-variable)
  - [✅tag-teal-background [variable]](#tag-teal-background-variable)
  - [✅tag-teal-color [variable]](#tag-teal-color-variable)
  - [✅tag-teal-hover [variable]](#tag-teal-hover-variable)
  - [✅tag-green-background [variable]](#tag-green-background-variable)
  - [✅tag-green-color [variable]](#tag-green-color-variable)
  - [✅tag-green-hover [variable]](#tag-green-hover-variable)
  - [✅tag-gray-background [variable]](#tag-gray-background-variable)
  - [✅tag-gray-color [variable]](#tag-gray-color-variable)
  - [✅tag-gray-hover [variable]](#tag-gray-hover-variable)
  - [✅tag-cool-gray-background [variable]](#tag-cool-gray-background-variable)
  - [✅tag-cool-gray-color [variable]](#tag-cool-gray-color-variable)
  - [✅tag-cool-gray-hover [variable]](#tag-cool-gray-hover-variable)
  - [✅tag-warm-gray-background [variable]](#tag-warm-gray-background-variable)
  - [✅tag-warm-gray-color [variable]](#tag-warm-gray-color-variable)
  - [✅tag-warm-gray-hover [variable]](#tag-warm-gray-hover-variable)
...
@mixin carbon--theme($theme: $carbon--theme, $emit-custom-properties: false) {
  ...
  $tag-red-background: map-get($theme, 'tag-red-background') !global;
  $tag-red-color: map-get($theme, 'tag-red-color') !global;
  $tag-red-hover: map-get($theme, 'tag-red-hover') !global;
  $tag-magenta-background: map-get($theme, 'tag-magenta-background') !global;
  $tag-magenta-color: map-get($theme, 'tag-magenta-color') !global;
  $tag-magenta-hover: map-get($theme, 'tag-magenta-hover') !global;
  $tag-purple-background: map-get($theme, 'tag-purple-background') !global;
  $tag-purple-color: map-get($theme, 'tag-purple-color') !global;
  $tag-purple-hover: map-get($theme, 'tag-purple-hover') !global;
  $tag-blue-background: map-get($theme, 'tag-blue-background') !global;
  $tag-blue-color: map-get($theme, 'tag-blue-color') !global;
  $tag-blue-hover: map-get($theme, 'tag-blue-hover') !global;
  $tag-cyan-background: map-get($theme, 'tag-cyan-background') !global;
  $tag-cyan-color: map-get($theme, 'tag-cyan-color') !global;
  $tag-cyan-hover: map-get($theme, 'tag-cyan-hover') !global;
  $tag-teal-background: map-get($theme, 'tag-teal-background') !global;
  $tag-teal-color: map-get($theme, 'tag-teal-color') !global;
  $tag-teal-hover: map-get($theme, 'tag-teal-hover') !global;
  $tag-green-background: map-get($theme, 'tag-green-background') !global;
  $tag-green-color: map-get($theme, 'tag-green-color') !global;
  $tag-green-hover: map-get($theme, 'tag-green-hover') !global;
  $tag-gray-background: map-get($theme, 'tag-gray-background') !global;
  $tag-gray-color: map-get($theme, 'tag-gray-color') !global;
  $tag-gray-hover: map-get($theme, 'tag-gray-hover') !global;
  $tag-cool-gray-background: map-get(
    $theme,
    'tag-cool-gray-background'
  ) !global;
  $tag-cool-gray-color: map-get($theme, 'tag-cool-gray-color') !global;
  $tag-cool-gray-hover: map-get($theme, 'tag-cool-gray-hover') !global;
  $tag-warm-gray-background: map-get(
    $theme,
    'tag-warm-gray-background'
  ) !global;
  $tag-warm-gray-color: map-get($theme, 'tag-warm-gray-color') !global;
  $tag-warm-gray-hover: map-get($theme, 'tag-warm-gray-hover') !global;
    ...
    map-get($feature-flags, 'enable-css-custom-properties')
  {
    ...
    $tag-red-background: var(
      --#{$custom-property-prefix}-tag-red-background,
      map-get($theme, 'tag-red-background')
    ) !global;
    $tag-red-color: var(
      --#{$custom-property-prefix}-tag-red-color,
      map-get($theme, 'tag-red-color')
    ) !global;
    $tag-red-hover: var(
      --#{$custom-property-prefix}-tag-red-hover,
      map-get($theme, 'tag-red-hover')
    ) !global;
    $tag-magenta-background: var(
      --#{$custom-property-prefix}-tag-magenta-background,
      map-get($theme, 'tag-magenta-background')
    ) !global;
    $tag-magenta-color: var(
      --#{$custom-property-prefix}-tag-magenta-color,
      map-get($theme, 'tag-magenta-color')
    ) !global;
    $tag-magenta-hover: var(
      --#{$custom-property-prefix}-tag-magenta-hover,
      map-get($theme, 'tag-magenta-hover')
    ) !global;
    $tag-purple-background: var(
      --#{$custom-property-prefix}-tag-purple-background,
      map-get($theme, 'tag-purple-background')
    ) !global;
    $tag-purple-color: var(
      --#{$custom-property-prefix}-tag-purple-color,
      map-get($theme, 'tag-purple-color')
    ) !global;
    $tag-purple-hover: var(
      --#{$custom-property-prefix}-tag-purple-hover,
      map-get($theme, 'tag-purple-hover')
    ) !global;
    $tag-blue-background: var(
      --#{$custom-property-prefix}-tag-blue-background,
      map-get($theme, 'tag-blue-background')
    ) !global;
    $tag-blue-color: var(
      --#{$custom-property-prefix}-tag-blue-color,
      map-get($theme, 'tag-blue-color')
    ) !global;
    $tag-blue-hover: var(
      --#{$custom-property-prefix}-tag-blue-hover,
      map-get($theme, 'tag-blue-hover')
    ) !global;
    $tag-cyan-background: var(
      --#{$custom-property-prefix}-tag-cyan-background,
      map-get($theme, 'tag-cyan-background')
    ) !global;
    $tag-cyan-color: var(
      --#{$custom-property-prefix}-tag-cyan-color,
      map-get($theme, 'tag-cyan-color')
    ) !global;
    $tag-cyan-hover: var(
      --#{$custom-property-prefix}-tag-cyan-hover,
      map-get($theme, 'tag-cyan-hover')
    ) !global;
    $tag-teal-background: var(
      --#{$custom-property-prefix}-tag-teal-background,
      map-get($theme, 'tag-teal-background')
    ) !global;
    $tag-teal-color: var(
      --#{$custom-property-prefix}-tag-teal-color,
      map-get($theme, 'tag-teal-color')
    ) !global;
    $tag-teal-hover: var(
      --#{$custom-property-prefix}-tag-teal-hover,
      map-get($theme, 'tag-teal-hover')
    ) !global;
    $tag-green-background: var(
      --#{$custom-property-prefix}-tag-green-background,
      map-get($theme, 'tag-green-background')
    ) !global;
    $tag-green-color: var(
      --#{$custom-property-prefix}-tag-green-color,
      map-get($theme, 'tag-green-color')
    ) !global;
    $tag-green-hover: var(
      --#{$custom-property-prefix}-tag-green-hover,
      map-get($theme, 'tag-green-hover')
    ) !global;
    $tag-gray-background: var(
      --#{$custom-property-prefix}-tag-gray-background,
      map-get($theme, 'tag-gray-background')
    ) !global;
    $tag-gray-color: var(
      --#{$custom-property-prefix}-tag-gray-color,
      map-get($theme, 'tag-gray-color')
    ) !global;
    $tag-gray-hover: var(
      --#{$custom-property-prefix}-tag-gray-hover,
      map-get($theme, 'tag-gray-hover')
    ) !global;
    $tag-cool-gray-background: var(
      --#{$custom-property-prefix}-tag-cool-gray-background,
      map-get($theme, 'tag-cool-gray-background')
    ) !global;
    $tag-cool-gray-color: var(
      --#{$custom-property-prefix}-tag-cool-gray-color,
      map-get($theme, 'tag-cool-gray-color')
    ) !global;
    $tag-cool-gray-hover: var(
      --#{$custom-property-prefix}-tag-cool-gray-hover,
      map-get($theme, 'tag-cool-gray-hover')
    ) !global;
    $tag-warm-gray-background: var(
      --#{$custom-property-prefix}-tag-warm-gray-background,
      map-get($theme, 'tag-warm-gray-background')
    ) !global;
    $tag-warm-gray-color: var(
      --#{$custom-property-prefix}-tag-warm-gray-color,
      map-get($theme, 'tag-warm-gray-color')
    ) !global;
    $tag-warm-gray-hover: var(
      --#{$custom-property-prefix}-tag-warm-gray-hover,
      map-get($theme, 'tag-warm-gray-hover')
    ) !global;
    $spacing-01: var(
  ...
  @if $emit-custom-properties == true {
    ...
    @if should-emit($theme, $carbon--theme, 'tag-red-color', $emit-difference) {
      @include custom-property(
        'tag-red-color',
        map-get($theme, 'tag-red-color')
      );
    ...
    @if should-emit($theme, $carbon--theme, 'tag-red-hover', $emit-difference) {
      @include custom-property(
        'tag-red-hover',
        map-get($theme, 'tag-red-hover')
      );
    ...
    @if should-emit($theme, $carbon--theme, 'tag-blue-color', $emit-difference)
    {
      @include custom-property(
        'tag-blue-color',
        map-get($theme, 'tag-blue-color')
    ...
    @if should-emit($theme, $carbon--theme, 'tag-blue-hover', $emit-difference)
    {
      @include custom-property(
        'tag-blue-hover',
        map-get($theme, 'tag-blue-hover')
    ...
    @if should-emit($theme, $carbon--theme, 'tag-cyan-color', $emit-difference)
    {
      @include custom-property(
        'tag-cyan-color',
        map-get($theme, 'tag-cyan-color')
    ...
    @if should-emit($theme, $carbon--theme, 'tag-cyan-hover', $emit-difference)
    {
      @include custom-property(
        'tag-cyan-hover',
        map-get($theme, 'tag-cyan-hover')
    ...
    @if should-emit($theme, $carbon--theme, 'tag-teal-color', $emit-difference)
    {
      @include custom-property(
        'tag-teal-color',
        map-get($theme, 'tag-teal-color')
    ...
    @if should-emit($theme, $carbon--theme, 'tag-teal-hover', $emit-difference)
    {
      @include custom-property(
        'tag-teal-hover',
        map-get($theme, 'tag-teal-hover')
    ...
    @if should-emit($theme, $carbon--theme, 'tag-green-color', $emit-difference)
    {
      @include custom-property(
        'tag-green-color',
        map-get($theme, 'tag-green-color')
    ...
    @if should-emit($theme, $carbon--theme, 'tag-green-hover', $emit-difference)
    {
      @include custom-property(
        'tag-green-hover',
        map-get($theme, 'tag-green-hover')
    ...
    @if should-emit($theme, $carbon--theme, 'tag-gray-color', $emit-difference)
    {
      @include custom-property(
        'tag-gray-color',
        map-get($theme, 'tag-gray-color')
    ...
    @if should-emit($theme, $carbon--theme, 'tag-gray-hover', $emit-difference)
    {
      @include custom-property(
        'tag-gray-hover',
        map-get($theme, 'tag-gray-hover')
...
$carbon--theme--g90: map-merge(
  ...
  (
    ...
    active-01: #6f6f6f,
    hover-field: #4c4c4c,
    tag-red-background: #750e13,
    tag-red-color: #ffb3b8,
    tag-red-hover: #a2191f,
    tag-magenta-background: #740937,
    tag-magenta-color: #ffafd2,
    tag-magenta-hover: #9f1853,
    tag-purple-background: #491d8b,
    tag-purple-color: #d4bbff,
    tag-purple-hover: #6929c4,
    tag-blue-background: #002d9c,
    tag-blue-color: #a6c8ff,
    tag-blue-hover: #0043ce,
    tag-cyan-background: #003a6d,
    tag-cyan-color: #82cfff,
    tag-cyan-hover: #00539a,
    tag-teal-background: #004144,
    tag-teal-color: #3ddbd9,
    tag-teal-hover: #005d5d,
    tag-green-background: #044317,
    tag-green-color: #6fdc8c,
    tag-green-hover: #0e6027,
    tag-gray-background: #393939,
    tag-gray-color: #c6c6c6,
    tag-gray-hover: #525252,
    tag-cool-gray-background: #343a3f,
    tag-cool-gray-color: #c1c7cd,
    tag-cool-gray-hover: #4d5358,
    tag-warm-gray-background: #3c3838,
    tag-warm-gray-color: #cac5c4,
    tag-warm-gray-hover: #565151,
  )
);
```
...
$carbon--theme: (
  ...
  tag-red-background: if(global-variable-exists('tag-red-background'), $tag-red-background, map-get($carbon--theme--white, 'tag-red-background')),
  tag-red-color: if(global-variable-exists('tag-red-color'), $tag-red-color, map-get($carbon--theme--white, 'tag-red-color')),
  tag-red-hover: if(global-variable-exists('tag-red-hover'), $tag-red-hover, map-get($carbon--theme--white, 'tag-red-hover')),
  tag-magenta-background: if(global-variable-exists('tag-magenta-background'), $tag-magenta-background, map-get($carbon--theme--white, 'tag-magenta-background')),
  tag-magenta-color: if(global-variable-exists('tag-magenta-color'), $tag-magenta-color, map-get($carbon--theme--white, 'tag-magenta-color')),
  tag-magenta-hover: if(global-variable-exists('tag-magenta-hover'), $tag-magenta-hover, map-get($carbon--theme--white, 'tag-magenta-hover')),
  tag-purple-background: if(global-variable-exists('tag-purple-background'), $tag-purple-background, map-get($carbon--theme--white, 'tag-purple-background')),
  tag-purple-color: if(global-variable-exists('tag-purple-color'), $tag-purple-color, map-get($carbon--theme--white, 'tag-purple-color')),
  tag-purple-hover: if(global-variable-exists('tag-purple-hover'), $tag-purple-hover, map-get($carbon--theme--white, 'tag-purple-hover')),
  tag-blue-background: if(global-variable-exists('tag-blue-background'), $tag-blue-background, map-get($carbon--theme--white, 'tag-blue-background')),
  tag-blue-color: if(global-variable-exists('tag-blue-color'), $tag-blue-color, map-get($carbon--theme--white, 'tag-blue-color')),
  tag-blue-hover: if(global-variable-exists('tag-blue-hover'), $tag-blue-hover, map-get($carbon--theme--white, 'tag-blue-hover')),
  tag-cyan-background: if(global-variable-exists('tag-cyan-background'), $tag-cyan-background, map-get($carbon--theme--white, 'tag-cyan-background')),
  tag-cyan-color: if(global-variable-exists('tag-cyan-color'), $tag-cyan-color, map-get($carbon--theme--white, 'tag-cyan-color')),
  tag-cyan-hover: if(global-variable-exists('tag-cyan-hover'), $tag-cyan-hover, map-get($carbon--theme--white, 'tag-cyan-hover')),
  tag-teal-background: if(global-variable-exists('tag-teal-background'), $tag-teal-background, map-get($carbon--theme--white, 'tag-teal-background')),
  tag-teal-color: if(global-variable-exists('tag-teal-color'), $tag-teal-color, map-get($carbon--theme--white, 'tag-teal-color')),
  tag-teal-hover: if(global-variable-exists('tag-teal-hover'), $tag-teal-hover, map-get($carbon--theme--white, 'tag-teal-hover')),
  tag-green-background: if(global-variable-exists('tag-green-background'), $tag-green-background, map-get($carbon--theme--white, 'tag-green-background')),
  tag-green-color: if(global-variable-exists('tag-green-color'), $tag-green-color, map-get($carbon--theme--white, 'tag-green-color')),
  tag-green-hover: if(global-variable-exists('tag-green-hover'), $tag-green-hover, map-get($carbon--theme--white, 'tag-green-hover')),
  tag-gray-background: if(global-variable-exists('tag-gray-background'), $tag-gray-background, map-get($carbon--theme--white, 'tag-gray-background')),
  tag-gray-color: if(global-variable-exists('tag-gray-color'), $tag-gray-color, map-get($carbon--theme--white, 'tag-gray-color')),
  tag-gray-hover: if(global-variable-exists('tag-gray-hover'), $tag-gray-hover, map-get($carbon--theme--white, 'tag-gray-hover')),
  tag-cool-gray-background: if(global-variable-exists('tag-cool-gray-background'), $tag-cool-gray-background, map-get($carbon--theme--white, 'tag-cool-gray-background')),
  tag-cool-gray-color: if(global-variable-exists('tag-cool-gray-color'), $tag-cool-gray-color, map-get($carbon--theme--white, 'tag-cool-gray-color')),
  tag-cool-gray-hover: if(global-variable-exists('tag-cool-gray-hover'), $tag-cool-gray-hover, map-get($carbon--theme--white, 'tag-cool-gray-hover')),
  tag-warm-gray-background: if(global-variable-exists('tag-warm-gray-background'), $tag-warm-gray-background, map-get($carbon--theme--white, 'tag-warm-gray-background')),
  tag-warm-gray-color: if(global-variable-exists('tag-warm-gray-color'), $tag-warm-gray-color, map-get($carbon--theme--white, 'tag-warm-gray-color')),
  tag-warm-gray-hover: if(global-variable-exists('tag-warm-gray-hover'), $tag-warm-gray-hover, map-get($carbon--theme--white, 'tag-warm-gray-hover')),
...
### ✅tag-red-background [variable]

<details>
<summary>Source code</summary>

```scss
$tag-red-background: if(
  global-variable-exists('carbon--theme') and map-has-key(
      $carbon--theme,
      'tag-red-background'
    ),
  map-get($carbon--theme, 'tag-red-background'),
  #ffd7d9
);
```
...
$tag-red-color: if(
  ...
  map-get($carbon--theme, 'tag-red-color'),
  #a2191f
);
```
...
$tag-red-hover: if(
  ...
  map-get($carbon--theme, 'tag-red-hover'),
  #ffb3b8
);
```
...
### ✅tag-magenta-background [variable]

<details>
<summary>Source code</summary>

```scss
$tag-magenta-background: if(
  global-variable-exists('carbon--theme') and map-has-key(
      $carbon--theme,
      'tag-magenta-background'
    ),
  map-get($carbon--theme, 'tag-magenta-background'),
  #ffd6e8
);
```
...
### ✅tag-magenta-color [variable]

<details>
<summary>Source code</summary>

```scss
$tag-magenta-color: if(
  global-variable-exists('carbon--theme') and map-has-key(
      $carbon--theme,
      'tag-magenta-color'
    ),
  map-get($carbon--theme, 'tag-magenta-color'),
  #9f1853
);
```
...
### ✅tag-magenta-hover [variable]

<details>
<summary>Source code</summary>

```scss
$tag-magenta-hover: if(
  global-variable-exists('carbon--theme') and map-has-key(
      $carbon--theme,
      'tag-magenta-hover'
    ),
  map-get($carbon--theme, 'tag-magenta-hover'),
  #ffafd2
);
```
...
### ✅tag-purple-background [variable]

<details>
<summary>Source code</summary>

```scss
$tag-purple-background: if(
  global-variable-exists('carbon--theme') and map-has-key(
      $carbon--theme,
      'tag-purple-background'
    ),
  map-get($carbon--theme, 'tag-purple-background'),
  #e8daff
);
```
...
$tag-purple-color: if(
  ...
  map-get($carbon--theme, 'tag-purple-color'),
  #6929c4
);
```
...
$tag-purple-hover: if(
  ...
  map-get($carbon--theme, 'tag-purple-hover'),
  #d4bbff
);
```
...
### ✅tag-blue-background [variable]

<details>
<summary>Source code</summary>

```scss
$tag-blue-background: if(
  global-variable-exists('carbon--theme') and map-has-key(
      $carbon--theme,
      'tag-blue-background'
    ),
  map-get($carbon--theme, 'tag-blue-background'),
  #d0e2ff
);
```
...
$tag-blue-color: if(
  ...
  map-get($carbon--theme, 'tag-blue-color'),
  #0043ce
);
```
...
$tag-blue-hover: if(
  ...
  map-get($carbon--theme, 'tag-blue-hover'),
  #a6c8ff
);
```
...
### ✅tag-cyan-background [variable]

<details>
<summary>Source code</summary>

```scss
$tag-cyan-background: if(
  global-variable-exists('carbon--theme') and map-has-key(
      $carbon--theme,
      'tag-cyan-background'
    ),
  map-get($carbon--theme, 'tag-cyan-background'),
  #bae6ff
);
```
...
$tag-cyan-color: if(
  ...
  map-get($carbon--theme, 'tag-cyan-color'),
  #00539a
);
```
...
$tag-cyan-hover: if(
  ...
  map-get($carbon--theme, 'tag-cyan-hover'),
  #82cfff
);
```
...
### ✅tag-teal-background [variable]

<details>
<summary>Source code</summary>

```scss
$tag-teal-background: if(
  global-variable-exists('carbon--theme') and map-has-key(
      $carbon--theme,
      'tag-teal-background'
    ),
  map-get($carbon--theme, 'tag-teal-background'),
  #9ef0f0
);
```
...
$tag-teal-color: if(
  ...
  map-get($carbon--theme, 'tag-teal-color'),
  #005d5d
);
```
...
$tag-teal-hover: if(
  ...
  map-get($carbon--theme, 'tag-teal-hover'),
  #3ddbd9
);
```
...
### ✅tag-green-background [variable]

<details>
<summary>Source code</summary>

```scss
$tag-green-background: if(
  global-variable-exists('carbon--theme') and map-has-key(
      $carbon--theme,
      'tag-green-background'
    ),
  map-get($carbon--theme, 'tag-green-background'),
  #a7f0ba
);
```
...
$tag-green-color: if(
  ...
  map-get($carbon--theme, 'tag-green-color'),
  #0e6027
);
```
...
$tag-green-hover: if(
  ...
  map-get($carbon--theme, 'tag-green-hover'),
  #6fdc8c
);
```
...
### ✅tag-gray-background [variable]

<details>
<summary>Source code</summary>

```scss
$tag-gray-background: if(
  global-variable-exists('carbon--theme') and map-has-key(
      $carbon--theme,
      'tag-gray-background'
    ),
  map-get($carbon--theme, 'tag-gray-background'),
  #e0e0e0
);
```
...
$tag-gray-color: if(
  ...
  map-get($carbon--theme, 'tag-gray-color'),
  #525252
);
```
...
$tag-gray-hover: if(
  ...
  map-get($carbon--theme, 'tag-gray-hover'),
  #c6c6c6
);
```
...
### ✅tag-cool-gray-background [variable]

<details>
<summary>Source code</summary>

```scss
$tag-cool-gray-background: if(
  global-variable-exists('carbon--theme') and map-has-key(
      $carbon--theme,
      'tag-cool-gray-background'
    ),
  map-get($carbon--theme, 'tag-cool-gray-background'),
  #dde1e6
);
```
...
### ✅tag-cool-gray-color [variable]

<details>
<summary>Source code</summary>

```scss
$tag-cool-gray-color: if(
  global-variable-exists('carbon--theme') and map-has-key(
      $carbon--theme,
      'tag-cool-gray-color'
    ),
  map-get($carbon--theme, 'tag-cool-gray-color'),
  #4d5358
);
```
...
### ✅tag-cool-gray-hover [variable]

<details>
<summary>Source code</summary>

```scss
$tag-cool-gray-hover: if(
  global-variable-exists('carbon--theme') and map-has-key(
      $carbon--theme,
      'tag-cool-gray-hover'
    ),
  map-get($carbon--theme, 'tag-cool-gray-hover'),
  #c1c7cd
);
```
...
### ✅tag-warm-gray-background [variable]

<details>
<summary>Source code</summary>

```scss
$tag-warm-gray-background: if(
  global-variable-exists('carbon--theme') and map-has-key(
      $carbon--theme,
      'tag-warm-gray-background'
    ),
  map-get($carbon--theme, 'tag-warm-gray-background'),
  #e5e0df
);
```
...
### ✅tag-warm-gray-color [variable]

<details>
<summary>Source code</summary>

```scss
$tag-warm-gray-color: if(
  global-variable-exists('carbon--theme') and map-has-key(
      $carbon--theme,
      'tag-warm-gray-color'
    ),
  map-get($carbon--theme, 'tag-warm-gray-color'),
  #565151
);
```
...
### ✅tag-warm-gray-hover [variable]

<details>
<summary>Source code</summary>

```scss
$tag-warm-gray-hover: if(
  global-variable-exists('carbon--theme') and map-has-key(
      $carbon--theme,
      'tag-warm-gray-hover'
    ),
  map-get($carbon--theme, 'tag-warm-gray-hover'),
  #cac5c4
);
```
...
@mixin tags() {
  ...
  .#{$prefix}--tag--red {
    @include tag-theme($tag-red-background, $tag-red-color, $tag-red-hover);
  }
  ...
  .#{$prefix}--tag--blue {
    @include tag-theme($tag-blue-background, $tag-blue-color, $tag-blue-hover);
  }

  .#{$prefix}--tag--cyan {
    @include tag-theme($tag-cyan-background, $tag-cyan-color, $tag-cyan-hover);
  }

  .#{$prefix}--tag--teal {
    @include tag-theme($tag-teal-background, $tag-teal-color, $tag-teal-hover);
  }
  ...
  .#{$prefix}--tag--gray {
    @include tag-theme($tag-gray-background, $tag-gray-color, $tag-gray-hover);
  }
