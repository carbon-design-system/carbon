...
export const sizeExtraSmall = rem(1.5);
export const sizeSmall = rem(2);
export const sizeMedium = rem(2.5);
export const sizeLarge = rem(3);
export const sizeExtraLarge = rem(4);
export const sizeDoubleExtraLarge = rem(5);
export const sizes = [
  sizeExtraSmall,
  sizeSmall,
  sizeMedium,
