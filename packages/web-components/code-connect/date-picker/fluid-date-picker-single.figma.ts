...
function createTemplate() {
  if (isSkeleton) {
    return {
      ...
      example: figma.code`<cds-fluid-date-picker-skeleton date-picker-type="single"></cds-fluid-date-picker-skeleton>`,
  ...
  <cds-fluid-date-picker-input kind="single"${renderStringAttribute(
    'label-text',
    labelText
  )}${renderStringAttribute(
    'placeholder',
