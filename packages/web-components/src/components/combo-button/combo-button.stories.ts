...
const argTypes = {
  ...
  tooltipContent: {
    control: 'text',
    description: 'Specify the content of the trigger tooltip.',
  },
};
...
export const withMenuAlignment = {
  ...
  parameters: {
    controls: {
      include: ['disabled', 'menuAlignment', 'onClick', 'size'],
    },
  },
  render: ({ disabled, onClick, size }) => html`
