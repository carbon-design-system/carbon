 ...
 * @element cds-interstitial-screen-footer
 * @fires cds-on-action - The name of the custom event fired just before the action. You can use this event to perform any async/sync validation.
