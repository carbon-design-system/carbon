    ...
    return html`
      <div style="padding: 2rem; background: var(--cds-layer-01);">
        ...
        <cds-action-set
          ...
          .actions="${actions}"></cds-action-set>
      </div>
    `;
  },
};
  ...
  render: () => {
    ...
    return html`
      <div style="padding: 2rem; background: var(--cds-layer-01);">
        ...
        <cds-action-set size="sm" .actions="${actions}"></cds-action-set>

        <h3 style="margin: 2rem 0 1rem;">Medium (md)</h3>
        <cds-action-set size="md" .actions="${actions}"></cds-action-set>

        <h3 style="margin: 2rem 0 1rem;">Large (lg)</h3>
        <cds-action-set size="lg" .actions="${actions}"></cds-action-set>

        <h3 style="margin: 2rem 0 1rem;">Extra Large (xl)</h3>
        <cds-action-set size="xl" .actions="${actions}"></cds-action-set>

        <h3 style="margin: 2rem 0 1rem;">2XL (2xl)</h3>
        <cds-action-set size="2xl" .actions="${actions}"></cds-action-set>
      </div>
    `;
  },
};
