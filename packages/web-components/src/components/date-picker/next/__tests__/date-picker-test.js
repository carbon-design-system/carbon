...
describe('cds-preview-date-picker', () => {
    ...
    it('should not show invalid state when disabled', async () => {
      const el = await fixture(html`
        <cds-preview-date-picker-input
          ...
          disabled
          label-text="Date Input"></cds-preview-date-picker-input>
      `);
  ...
  describe('Date Picker Functionality', () => {
    ...
    it('should handle value changes', async () => {
      const el = await fixture(html`
        <cds-preview-date-picker value="2024-01-15">
          <cds-preview-date-picker-input
            kind="single"
            label-text="Date"
            placeholder="mm/dd/yyyy">
    ...
    it('should handle disabled state', async () => {
      const el = await fixture(html`
        <cds-preview-date-picker disabled>
          <cds-preview-date-picker-input
            kind="single"
            label-text="Date"
            placeholder="mm/dd/yyyy">
