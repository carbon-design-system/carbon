...
- [Component API](#component-api)
  ...
  - [`cds-date-picker-v2`](#cds-date-picker-v2)
  - [`cds-date-picker-v2-input`](#cds-date-picker-v2-input)
...
location or need. The `cds-date-picker-v2` component expects one or more
`cds-date-picker-v2-input` elements as children.
...
You can use the `cds-date-picker-v2-input-skeleton` component to render a
...
**`cds-date-picker-v2` attributes/properties:**
...
**`cds-date-picker-v2-input` attributes/properties:**
...
- `cds-date-picker-v2-changed` - Fired when date selection changes
- `cds-date-picker-v2-error` - Fired when an error occurs
...
<ArgTypes of="cds-date-picker-v2" />

## `cds-date-picker-v2-input`

<ArgTypes of="cds-date-picker-v2-input" />
...
<cds-date-picker-v2 date-format="Y-m-d">
  <cds-date-picker-v2-input
    kind="single"
    label-text="Date format example"
    placeholder="yyyy/mm/dd"></cds-date-picker-v2-input>
</cds-date-picker-v2>
...
- For `range` , two `cds-date-picker-v2-input` will need to be provided as
  children.

For `simple` and `single`, set the `kind` attribute of the
`cds-date-picker-v2-input` component to the desired version.

```html
<cds-date-picker-v2>
  <cds-date-picker-v2-input
    kind="single"
    placeholder="mm/dd/yyyy"></cds-date-picker-v2-input>
</cds-date-picker-v2>
```
...
<cds-date-picker-v2 max-date="09/15/2020">
  <cds-date-picker-v2-input
    kind="single"
...
<cds-date-picker-v2 min-date="09/15/2025">
  <cds-date-picker-v2-input
    kind="single"
...
<cds-date-picker-v2>
  <cds-date-picker-v2-input
    ...
    placeholder="mm/dd/yyyy"
    value="04/17/2025"></cds-date-picker-v2-input>
</cds-date-picker-v2>
...
- Positioning uses
  ...
  for smart placement
- The `cds-date-picker-v2-input` component takes in similar attributes to the
...
[GitHub](https://github.com/carbon-design-system/carbon/edit/main/packages/web-components/src/components/date-picker/next/__stories__/date-picker-v2.mdx).
