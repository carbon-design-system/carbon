...
export const IconOnly = {
  ...
  render: ({ value, size, selectionMode, selectedIndex, lowContrast }) => html`
    <cds-content-switcher
      ...
      <cds-content-switcher-item icon value="cloudFoundry" ?lowcontrast="${lowContrast}">
        ${Workspace16()}
        <span slot="tooltip-content">Workspace Test</span>
      </cds-content-switcher-item>
      <cds-content-switcher-item icon value="staging" ?lowcontrast="${lowContrast}">
        ${ViewMode2_16()}
  ...
  render: ({
    ...
    return html`
      <cds-content-switcher
        ...
        <cds-content-switcher-item ?lowcontrast="${lowContrast}" value="cloudFoundry">
          Second section
        </cds-content-switcher-item>
        <cds-content-switcher-item ?lowcontrast="${lowContrast}" value="staging">
          Third section
        </cds-content-switcher-item>
      </cds-content-switcher>
    `;
