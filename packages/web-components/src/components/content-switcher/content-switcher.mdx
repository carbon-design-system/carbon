...
<cds-content-switcher>
  <cds-content-switcher-item disabled value="all" name="one" text="First section">
    First section
  </cds-content-switcher-item>
  <cds-content-switcher-item disabled value="cloudFoundry " name="two" text="Second section">
    Second section
  </cds-content-switcher-item>
  <cds-content-switcher-item disabled value="staging" name="three" text="Third section">
    Third section
  </cds-content-switcher-item>
</cds-content-switcher>
