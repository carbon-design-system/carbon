...
const aiLabelContent = html`
  ...
  <p class="secondary">
    This content was generated using IBM AI services with high confidence based
...
export const WithAILabel = {
  ...
  render: () => html`
    ...
    <cds-grid>
      ...
      <cds-column lg="4" md="4" sm="4">
        <cds-card>
          <cds-ai-label slot="decorator" alignment="bottom" size="xs">
            ${aiLabelContent}
          </cds-ai-label>
          <cds-card-header>
      ...
      <cds-column lg="4" md="4" sm="4">
        <cds-card>
          ...
          <cds-card-body>
            Card with AI label and header media slot (icon).
          </cds-card-body>
        </cds-card>
      </cds-column>

      <!-- AI label + header actions -->
      <cds-column lg="4" md="4" sm="4">
        <cds-card>
          <cds-ai-label slot="decorator" alignment="bottom" size="xs">
            <p class="secondary">AI Explained</p>
          ...
          <cds-card-footer>
            <cds-card-action>
              <cds-button size="sm" kind="tertiary">View Details</cds-button>
            </cds-card-action>
          </cds-card-footer>
        </cds-card>
      </cds-column>
