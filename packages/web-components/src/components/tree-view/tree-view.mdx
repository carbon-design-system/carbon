...
The `is-expanded` attribute can be used to determine if an individual tree node is
...
The `href` attribute can be used with click handling on each of the tree nodes.
