    ...
    return html`
      ...
      <cds-notification-panel
                ...
                return html`
                  <cds-notification
                    ...
                    <cds-truncated-text
                      ...
                      collapse-label="Read less"></cds-truncated-text>
                  </cds-notification>
                `;
              })}
            `
        ...
        <cds-notification-footer
          ...
          @cds-notification-view-all=${action(`Clicked View All`)}
          @cds-notification-settings=${action(
            `Clicked Settings`
          )}></cds-notification-footer>
      </cds-notification-panel>
...
const meta: Meta = {
  ...
  component: 'cds-notification-panel',
};
