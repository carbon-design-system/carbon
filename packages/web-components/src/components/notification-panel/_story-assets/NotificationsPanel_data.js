...
export const dataPrevious = [
  ...
  },
  {
    ...
    description: html`
      <p
        class="cds--notifications-panel__notification-description cds--notifications-panel__notification-short-description">
      ...
      <button
        class="cds--notifications-panel__notification-read-more-button cds--btn cds--btn--sm cds--layout--size-sm cds--btn--ghost"
        type="button">
        Read more
        <svg
          focusable="false"
