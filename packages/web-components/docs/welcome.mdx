...
<p align="center">
  <a href="https://github.com/carbon-design-system/carbon-for-ibm-dotcom/blob/main/packages/carbon-web-components/LICENSE">
    <img
...
https://github.com/carbon-design-system/issue-tracking/issues/121.
...
Our example at
[Stackblitz](https://stackblitz.com/github/carbon-design-system/carbon/tree/main/packages/web-components/examples/components/dropdown)
shows the most basic usage:

The first thing you need is **setting up a module bundler** to resolve
ECMAScript `import`s. The above example uses [Vite JS](https://vite.dev/), but
you can use any modern ESM-capable bundler.
...
An alternative to using a bundler are CDN artifacts which can be added client
side in your html files. With CDNs, you can import the components in
`<script type="module">`:
...
In v2, Carbon web components self-register. Once a component is imported it is
added to the global registry. The next major release introduces a new
registration model that is side-effect free. Importing a class file no longer
self-registers the component, the registration must be explicit. See the
[component registration](../?path=/docs/introduction-component-registration--overview)
overview for full details.

### Other usage guides

- [Having components participate in form](../?path=/docs/introduction-form-participation--overview)
- [Using custom styles in components](../?path=/docs/introduction-custom-styles--overview)
- [Preparing for v3](https://github.com/carbon-design-system/carbon/blob/main/docs/guides/cwc-v3-migration.md)
