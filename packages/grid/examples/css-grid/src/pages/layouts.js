...
export default function LayoutsPage() {
  return (
    <div>
      ...
      {/* <h2>Define modes per-column</h2>
      <p>Place mode at the individual column level instead of for the whole grid. This is how you could ✨mix modes✨ between 'rows'.</p>
      <article className="example">
      <section className="bx--css-grid">
        <div className="bx--col-span-25">
          <p>Some text</p>
        ...
        <div className="bx--col-span-25 bx--col--narrow">
          <p className="bx--gutter-start">This column is defined as ✨narrow✨.</p>
          <Tile><p>As well as a Tile</p><Button>With a button inside</Button></Tile>
        </div>
        <div className="bx--col-span-25">
          <p>Some text</p>
        ...
        <div className="bx--col-span-25 bx--col--condensed">
          <p>This column is defined as condensed</p>
          <Tile><p>As well as a Tile</p><Button>With a button inside</Button></Tile>
        </div>
        <div className="bx--col-span-50 bx--col--narrow">
          <p className="bx--gutter-start">This column is defined as ✨narrow✨</p>
          <Tile><p>As well as a Tile</p><Button>With a button inside</Button></Tile>
        </div>
        <div className="bx--col-span-50 bx--col--narrow">
        ...
        <div className="bx--col-span-50 bx--col--condensed">
          <p className="bx--gutter-start">This column is defined as ✨condensed✨</p>
          <Tile><p>As well as a Tile</p><Button>With a button inside</Button></Tile>
        </div> */}
        {/* TODO per column level needs a border */}
        {/* <div className="bx--col-span-50 bx--col--condensed"> 
          <p className="bx--gutter-start">This column is defined as ✨condensed✨</p>
          <Tile><p>As well as a Tile</p><Button>With a button inside</Button></Tile>
        </div>
      ...
      {/* <h2>Mixed modes via <span className="subgrid">subgrid</span> and different grid modes per <span className="column">column</span></h2>
      <article className="example">
        <section className="bx--css-grid">
          <div className="bx--col-span-25 bx--subgrid">
            <div className="content bx--col-span-100 bx--col--narrow">
              <Tile>
                <p>This Tile is 25% width</p>
                <p>(4 internal columns)</p>
                <p>Per-column "narrow" class uses negative margin to pull this container into left gutter.</p>
              </Tile>
            </div>
          </div>
          <div className="bx--col-span-75 bx--subgrid">
            <div className="content bx--col-span-100 bx--col--condensed">
              <Tile>
                <p>This Tile is 75% width</p>
                <p>(8 internal columns)</p>
                <p>Per-column "condensed" class uses negative margin to pull this ontainer into left and right gutter.</p>
              </Tile>
            </div>
          </div>
        </section>
      ...
      {/* <h2>Defining sub grid modes at the subgrid level, not on columns.</h2>
      <p>Use of subgrid intends to establish a new grid mode for the interior of the container. </p>
      <article className="example">
        <section className="bx--css-grid">
          <p className="bx--col-span-100">Base grid mode: WIDE</p>
          ...
          <div className="bx--col-span-8 bx--subgrid bx--css-grid--narrow">
          ...
          <div className="bx--col-span-8 bx--subgrid bx--css-grid--condensed">
            <div className="content bx--col-span-2">
              <p>condensed</p>
            </div>
            <div className="content bx--col-span-2">
        ...
        <section className="bx--css-grid bx--css-grid--condensed">
          <p className="bx--col-span-100">Base grid mode: CONDENSED</p>
          <div className="bx--col-span-8 bx--subgrid bx--css-grid">
            <div className="content bx--col-span-2">
              <p>wide</p>
            </div>
            <div className="content bx--col-span-2">
        ...
        <section className="bx--css-grid  bx--css-grid--narrow">
          <p className="bx--col-span-100">Base grid mode: NARROW</p>
          <div className="bx--col-span-8 bx--subgrid bx--css-grid">
            <div className="content bx--col-span-2">
              <p>wide</p>
            </div>
