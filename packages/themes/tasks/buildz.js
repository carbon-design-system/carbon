...
async function build() {
  ...
  // ) !default;
  const themeMaps = Object.keys(themes).map(name => {
...
/ @group @carbon/themes`),
      ...
      body: t.BlockStatement({
        body: [
          ...tokenColors.map(token => {
            ...
            return t.Assignment(t.Identifier(name), t.SassString('foo'));
          }),
          t.AtContent(),
  ...
  // console.log(generate(themeMixin[0]).code);
  console.log(generate(themeMixin[1]).code);
