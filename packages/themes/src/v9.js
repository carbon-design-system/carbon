...
// Type
export { caption01 } from './base';
export { label01 } from './base';
export { helperText01 } from './base';
export { bodyShort01 } from './base';
export { bodyLong01 } from './base';
export { bodyShort02 } from './base';
export { bodyLong02 } from './base';
export { code01 } from './base';
export { code02 } from './base';
export { heading01 } from './base';
export { productiveHeading01 } from './base';
export { heading02 } from './base';
export { productiveHeading02 } from './base';
export { productiveHeading03 } from './base';
export { productiveHeading04 } from './base';
export { productiveHeading05 } from './base';
export { productiveHeading06 } from './base';
export { productiveHeading07 } from './base';
export { expressiveHeading01 } from './base';
export { expressiveHeading02 } from './base';
export { expressiveHeading03 } from './base';
export { expressiveHeading04 } from './base';
export { expressiveHeading05 } from './base';
export { expressiveHeading06 } from './base';
export { expressiveParagraph01 } from './base';
export { quotation01 } from './base';
export { quotation02 } from './base';
export { display01 } from './base';
export { display02 } from './base';
export { display03 } from './base';
export { display04 } from './base';
