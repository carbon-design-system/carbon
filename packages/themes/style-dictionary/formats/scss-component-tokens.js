 ...
 *
 * Replicates the output of `tasks/builders/dtcg-component-tokens.js`.
 *
 * Receives the tokens for ONE component (already expanded from the
 * carbon.themes multi-theme shape by the `carbon/component-tokens`
 ...
 *   ) !default;
 *
 * Theme name normalisation (matches `normalizeComponentThemeName` in
 * dtcg-converter.js):
 *   'white'  → 'white-theme'
 *   'g10'    → 'g-10'
 *   'g90'    → 'g-90'
 ...
 *
 *   platforms: {
 *     'scss/component-tokens/button': {
 *       files: [{
 *         destination: 'scss/generated/_button-tokens.scss',
 *         format: 'carbon/scss-component-tokens',
 *       }]
 *     }
 *   }
