 ...
 *
 * Replicates the output of `tasks/builders/dtcg-js-component-tokens.js`.
 *
 * Receives tokens for ONE component (pre-processed by
 * `carbon/component-tokens`) and emits two files:
 *   - `<componentName>.js`   — named ES exports, one per token
 *   - `<componentName>.d.ts` — companion TypeScript declarations
 *
 * Each export is an object keyed by theme name (camelCase):
 *   export const buttonDangerActive = { whiteTheme: '#a2191f', g10: '#a2191f', ... };
 *
 * Theme key normalisation (matches dtcg-js-component-tokens.js):
 *   'white' → 'whiteTheme'
 *   'g10'   → 'g10'
 *   'g90'   → 'g90'
 *   'g100'  → 'g100'
 ...
 *
 *   platforms: {
 *     'js/component-tokens/button': {
 *       files: [
 *         {
 *           destination: 'js/generated/component-tokens/button.js',
 *           format: 'carbon/js-component-tokens',
 *           options: { output: 'js' },
 *         },
 *         {
 *           destination: 'js/generated/component-tokens/button.d.ts',
 *           format: 'carbon/js-component-tokens',
 *           options: { output: 'dts' },
 *         },
 *       ]
