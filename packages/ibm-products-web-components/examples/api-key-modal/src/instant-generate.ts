 ...
 * InstantGenerate.
 *
 * @element instant-generate
 *
 * */

@customElement(`instant-generate`)
class InstantGenerate extends HostListenerMixin(LitElement) {
  ...
  render() {
    ...
    return html`
      ...
      ${this.loadingButton
        ? html`<cds-button
            kind="primary"
            class=${`${blockClass}__button-loading ${blockClass}__inline`}
            >Generating...
            <cds-inline-loading
              class=${`${blockClass}__inline-loading`}
            ></cds-inline-loading>
          </cds-button>`
        : html`<cds-button
            kind="primary"
...
export default InstantGenerate;
