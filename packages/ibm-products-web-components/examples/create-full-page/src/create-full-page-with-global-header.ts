...
/**
 * CreateFullPageWithGlobalHeader - Example with Carbon UI Shell header.
 *
...
class CreateFullPageWithGlobalHeader extends HostListenerMixin(LitElement) {
  ...
  @state()
  private isSideNavExpanded = false;
  ...
  private handleHeaderMenuButtonClick = () => {
...
export default CreateFullPageWithGlobalHeader;
