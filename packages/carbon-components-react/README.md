...
This package is a re-export of `carbon-components-react`
...
The `carbon-components-react` package also provides icon components that you can
include in your project. You can import these icon components from the
`carbon-components-react/icons` entrypoint:

```jsx
import { Add } from 'carbon-components-react/icons';
