...
describe('RepoPage - ', () => {
  it('should show error UI -', async () => {
    ...
    expect(await screen.findByText("Error! Error: An error occured")).toBeInTheDocument();
  ...
  it('load carbon data table successfully -', async () => {
    ...
    expect(document.getElementsByClassName('cds--data-table-header')).toHaveLength(1)
