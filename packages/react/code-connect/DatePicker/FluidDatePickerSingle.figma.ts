// url=https://www.figma.com/design/YAnB1jKx0yCUL29j6uSLpg/(v11)-All-themes---Carbon-Design-System?node-id=17544-267989&t=hgJuU7m9Y6EM076g-4
...
function createTemplate() {
  if (isSkeleton) {
    return {
      ...
      example: figma.code`<FluidDatePickerSkeleton datePickerType="single" />`,
  ...
  return {
    ...
    example: figma.code`<FluidDatePicker datePickerType="single">
  <FluidDatePickerInput id="date-picker-single"${figma.helpers.react.renderProp(
    'labelText',
    labelText
