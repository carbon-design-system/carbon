// url=https://www.figma.com/design/YAnB1jKx0yCUL29j6uSLpg/(v11)-All-themes---Carbon-Design-System?node-id=17544-267504&t=hgJuU7m9Y6EM076g-4
...
function createTemplate() {
  if (isSkeleton) {
    return {
      ...
      example: figma.code`<DatePickerSkeleton />`,
      metadata: { nestable: true },
    };
  }

  // The single-calendar Figma component does not expose "Show label".
  ...
  return {
    ...
    example: figma.code`<DatePicker datePickerType="single">
