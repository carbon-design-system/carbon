...
function createTemplate() {
  if (isSkeleton) {
    return {
      ...
      example: figma.code`<FluidDatePickerSkeleton datePickerType="range" />`,
  ...
  return {
    ...
    example: figma.code`<FluidDatePicker datePickerType="range"${figma.helpers.react.renderProp(
      'readOnly',
      readOnly
    )}>
  <FluidDatePickerInput id="date-picker-input-id-start"${figma.helpers.react.renderProp(
    'placeholder',
  ...
  <FluidDatePickerInput id="date-picker-input-id-finish"${figma.helpers.react.renderProp(
    'placeholder',
    datePickerInput.placeholder
