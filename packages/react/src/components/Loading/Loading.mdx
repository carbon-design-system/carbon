  ...
  additionalActions={[
    {
      ...
      onClick: () => stackblitzPrefillConfig({ story: LoadingStories.Default }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: LoadingStories.OverlayLoading,
          customFunctionDefs: useStartLoadingDef,
        }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: LoadingStories.OverlayLoadingBehindModal,
          customFunctionDefs: useStartLoadingDef,
        }),
    },
  ]}
