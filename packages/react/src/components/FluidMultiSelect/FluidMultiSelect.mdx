  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: FluidMultiSelectStories.Default,
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: FluidMultiSelectStories.Filterable,
          customFunctionDefs: [itemsDef],
        }),
    },
  ]}
...
<Canvas of={FluidMultiSelectStories._FilterableWithLayer} />
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () =>
        stackblitzPrefillConfig({ story: FluidMultiSelectStories.Skeleton }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: FluidMultiSelectStories.withAILabel,
          customFunctionDefs: [itemsDef],
        }),
    },
  ]}
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: FluidMultiSelectStories.Condensed,
          customFunctionDefs: [itemsDef],
        }),
    },
  ]}
