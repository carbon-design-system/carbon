  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig(
          FluidTFluidMultiSelectStoriesextAreaStories.Default
        ),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () =>
        stackblitzPrefillConfig(FluidMultiSelectStories.Filterable),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () =>
        stackblitzPrefillConfig(FluidMultiSelectStories._FilterableWithLayer),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () =>
        stackblitzPrefillConfig(FluidMultiSelectStories.withAILabel),
    },
  ]}
/>
