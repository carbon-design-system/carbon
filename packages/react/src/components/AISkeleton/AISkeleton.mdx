  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({ story: AISkeletonStories._AISkeletonIcon }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: AISkeletonPlaceholderStories._AISkeletonPlaceholder,
        }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: AISkeletonTextStories._AISkeletonText,
        }),
    },
  ]}
/>
