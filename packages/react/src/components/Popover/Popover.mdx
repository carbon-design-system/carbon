...
export const autoAlignStoryContainerStyleDef = `const autoAlignStoryContainerStyle = {
  display: 'grid',
  placeItems: 'center',
  width: '200vw',
  minWidth: '1200px',
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: PopoverStories.Default,
          customImports: [checkboxIconImport],
          styles: PopoverStories.default.parameters.styles,
        }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: PopoverStories.TabTip,
          customFunctionDefs: [prefixDef],
          styles: PopoverStories.default.parameters.styles,
        }),
    },
  ]}
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: PopoverStories.ExperimentalAutoAlign,
          customImports: [checkboxIconImport],
          customFunctionDefs: [autoAlignStoryContainerStyleDef],
          styles: PopoverStories.default.parameters.styles,
        }),
    },
  ]}
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: PopoverStories.ExperimentalAutoAlignBoundary,
          customImports: [checkboxIconImport],
          styles: PopoverStories.default.parameters.styles,
        }),
    },
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: PopoverStories.TabTipExperimentalAutoAlign,
          customImports: [checkboxIconImport],
          customFunctionDefs: [autoAlignStoryContainerStyleDef],
          styles: PopoverStories.default.parameters.styles,
        }),
