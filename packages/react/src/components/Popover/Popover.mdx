...
`bottom` to control this alignment.
  ...
  <Canvas
      ...
      additionalActions={[
        {
          title: 'Open in Stackblitz',
          onClick: () => stackblitzPrefillConfig(PopoverStories.ExperimentalAutoAlign),
        },
      ]}
  />
  ...
  <Canvas
      ...
      additionalActions={[
        {
          title: 'Open in Stackblitz',
          onClick: () => stackblitzPrefillConfig(PopoverStories.ExperimentalAutoAlignBoundary),
        },
      ]}
  />
    ...
    additionalActions={[
      {
        title: 'Open in Stackblitz',
        onClick: () => stackblitzPrefillConfig(PopoverStories.TabTipExperimentalAutoAlign),
      },
    ]}
  />
...
## Test
  ...
  <Canvas
    of={PopoverStories.Test}
    additionalActions={[
      {
        title: 'Open in Stackblitz',
        onClick: () => stackblitzPrefillConfig(PopoverStories.Test),
      },
    ]}
  />
