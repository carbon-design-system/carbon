...
| `enable-v12-tile-default-icons`                    | Enable default icons for Tile components                                             | `false` | ✅              |           | [Yes](/docs/getting-started-v12--overview#enable-v12-tile-default-icons) |
| `enable-v12-overflowmenu`                          | Enable the use of the v12 OverflowMenu leveraging the Menu subcomponents             | `false` | ✅              |           | [Yes](/docs/getting-started-v12--overview#enable-v12-overflowmenu) |
| `enable-v12-tile-radio-icons`                      | Enable rendering of default icons in the tile components                             | `false` | ✅              | ✅        | [Yes](/docs/getting-started-v12--overview#enable-v12-tile-radio-icons) |
| `enable-v12-structured-list-visible-icons`         | Enable icon components within StructuredList to always be visible                    | `false` |                 | ✅        | [Yes](/docs/getting-started-v12--overview#enable-v12-structured-list-visible-icons) |
...
- **Style only**: The flag only affects CSS styling with no component API changes
- **Config only**: The flag is a configuration option that users enable at selected places
- **App level**: The flag is typically applied at the application level in just a few places
