  ...
  additionalActions={[
    {
      ...
      onClick: () => stackblitzPrefillConfig({ story: HeadingStories.Default }),
    },
  ]}
/>
...
<ArgTypes of={HeadingStories.Default} />
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () =>
        stackblitzPrefillConfig({ story: HeadingStories.CustomLevel }),
    },
  ]}
/>
