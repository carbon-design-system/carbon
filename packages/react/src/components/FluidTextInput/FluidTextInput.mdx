  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: FluidTextInputStories.Default,
          styles: FluidTextInputStories.default.parameters.styles,
        }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: FluidTextInputStories.Skeleton,
          styles: FluidTextInputStories.default.parameters.styles,
        }),
    },
  ]}
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: FluidTextInputStories.DefaultWithToggletip,
          styles: FluidTextInputStories.default.parameters.styles,
        }),
    },
  ]}
