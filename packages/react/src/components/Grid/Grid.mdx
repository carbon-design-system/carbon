...
<Canvas>
  <Story of={GridStories.FullWidth} />
</Canvas>

### Condensed grid

<Canvas>
  <Story of={GridStories.Condensed} />
</Canvas>

### Narrow grid

<Canvas>
  <Story of={GridStories.Narrow} />
</Canvas>
...
For more specialized grid implementations you may want to disable the
automatic subgrid definition. To achieve this you can wrap your nested `Grid` 
in `GridSettings` and set `subgrid={false}`.
