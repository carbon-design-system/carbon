...
<Preview>
  <Story id="elements-grid--default" />
</Preview>
...
the `condensed` prop to enable the condensed gride mode with a 1px gutter or the
`narrow` prop to enable the narrow grid with a 16px gutter.

### Full width grid

<Preview>
  <Story id="elements-grid--full-width" />
</Preview>

### Condensed grid

<Preview>
  <Story id="elements-grid--condensed" />
</Preview>

### Narrow grid

<Preview>
  <Story id="elements-grid--narrow" />
</Preview>
...
<Preview>
  <Story id="elements-grid--subgrid" />
</Preview>
...
<Preview>
  <Story id="elements-grid--mixed-grid-modes" />
</Preview>
