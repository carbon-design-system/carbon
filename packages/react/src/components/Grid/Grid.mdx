  ...
  additionalActions={[
    {
      ...
      onClick: () => stackblitzPrefillConfig({ story: GridStories.Default }),
    },
  ]}
/>
...
<Canvas
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () => stackblitzPrefillConfig({ story: GridStories.FullWidth }),
    },
  ]}
/>
...
<Canvas
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () => stackblitzPrefillConfig({ story: GridStories.Condensed }),
    },
  ]}
/>
...
<Canvas
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () => stackblitzPrefillConfig({ story: GridStories.Narrow }),
    },
  ]}
/>
...
By default, the CSS Grid does not add vertical spacing (row gap) between grid
items. You can enable row gap by using the `withRowGap` prop on the `Grid`
component. When enabled, the row gap will automatically match the current gutter
size:

- Default mode: 2rem (32px) row gap
- Narrow mode: 1rem (16px) row gap
- Condensed mode: 1px row gap

This is useful when you want consistent vertical spacing between rows that
matches your horizontal gutter spacing.
...
<Canvas
  of={GridStories.WithRowGap}
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () => stackblitzPrefillConfig({ story: GridStories.WithRowGap }),
    },
  ]}
/>
...
<Canvas
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () => stackblitzPrefillConfig({ story: GridStories.Subgrid }),
    },
  ]}
/>
...
<Canvas
  of={GridStories.WithGridSettings}
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () =>
        stackblitzPrefillConfig({ story: GridStories.WithGridSettings }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () =>
        stackblitzPrefillConfig({ story: GridStories.MixedGutterModes }),
    },
  ]}
/>
...
<Canvas
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () => stackblitzPrefillConfig({ story: GridStories.Responsive }),
    },
  ]}
/>
...
<Canvas
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () => stackblitzPrefillConfig({ story: GridStories.Offset }),
    },
  ]}
/>
