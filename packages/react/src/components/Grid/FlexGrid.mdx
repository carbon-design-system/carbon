  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: FlexGridStories.ResponsiveGrid,
          customFunctionDefs: [demoContentDef],
        }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: FlexGridStories.FullWidth,
          customFunctionDefs: [demoContentDef],
        }),
    },
  ]}
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: FlexGridStories.Condensed,
          customFunctionDefs: [demoContentDef],
        }),
    },
  ]}
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: FlexGridStories.MixedGutterModes,
          customFunctionDefs: [demoContentDef],
        }),
    },
  ]}
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: FlexGridStories.AutoColumns,
          customFunctionDefs: [demoContentDef],
        }),
    },
  ]}
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: FlexGridStories.WithRowGap,
          customFunctionDefs: [demoContentDef],
        }),
    },
  ]}
