...
import dropContainerSrc from './stories/drop-container.js?raw';
import dragAndDropSingleSrc from './stories/drag-and-drop-single.js?raw';
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({ story: FileUploaderStories.Default }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story:
            FileUploaderStories.DragAndDropUploadContainerExampleApplication,
          customImports: [
            "import ExampleDropContainerApp from './stories/drop-container';",
          ],
          additionalFiles: {
            'src/stories/drop-container.tsx': dropContainerSrc,
          },
        }),
    },
  ]}
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story:
            FileUploaderStories.DragAndDropUploadSingleContainerExampleApplication,
          customImports: [
            "import ExampleDropContainerAppSingle from './stories/drag-and-drop-single';",
          ],
          additionalFiles: {
            'src/stories/drag-and-drop-single.tsx': dragAndDropSingleSrc,
          },
        }),
    },
  ]}
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: FileUploaderStories._FileUploaderDropContainer,
        }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: FileUploaderStories._FileUploaderItem,
        }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () =>
        stackblitzPrefillConfig({ story: FileUploaderStories.Skeleton }),
    },
  ]}
/>
