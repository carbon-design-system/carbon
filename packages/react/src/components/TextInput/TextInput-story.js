...
const ControlledPasswordInputApp = React.forwardRef(function ControlledPasswordInputApp(
  props,
  ref
) {
...
export const Default = () => (
  <TextInput type={select('Form control type (type)', types, 'text')} {...props.TextInputProps()} />
);
...
export const TogglePasswordVisibility = () => {
  return <TextInput.PasswordInput {...props.TextInputProps()} {...props.PasswordInputProps()} />;
};
...
export const FullyControlledTogglePasswordVisibility = () => {
  ...
  return <ControlledPasswordInputApp {...props.TextInputProps()} {...props.PasswordInputProps()} />;
};
