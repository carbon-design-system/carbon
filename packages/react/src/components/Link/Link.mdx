  ...
  additionalActions={[
    {
      ...
      onClick: () => stackblitzPrefillConfig({ story: LinkStories.Default }),
    },
  ]}
/>
...
<Canvas
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () => stackblitzPrefillConfig({ story: LinkStories.Inline }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () =>
        stackblitzPrefillConfig({ story: LinkStories.PairedWithIcon }),
    },
  ]}
/>
