...
// jsdom does not implement scrollBy — mock it so ConditionGroupBuilder's
// scroll-adjust effect doesn't trigger a "Not implemented" console.error.
beforeAll(() => {
...
import CustomInput from '../assets/CustomInput.jsx';
import {
  inputDataForCustomOperator,
  inputDataWithDisabledProperties,
} from '../assets/sampleInput.jsx';

const blockClass = 'cds--condition-builder';
...
// values to use
const className = `class-${crypto.randomUUID()}`;
const dataTestId = crypto.randomUUID();
const defaultProps = {
  inputConfig: {},
...
describe(componentName, () => {
  ...
  it('render the component with input type as single select option', async () => {
    ...
    await userEvent.click(screen.getByRole('option', { name: 'Continent' }));
  ...
  it('render the component with input type as multiselect option', async () => {
    ...
    await userEvent.click(screen.getByRole('option', { name: 'Antarctica' }));
  ...
  it('checking select/deselect all functionality for the input type option with multiselect', async () => {
    ...
    await userEvent.click(screen.getByText('Antarctica'));
  ...
  it('check search feature is functioning in popover', async () => {
    ...
    await userEvent.click(screen.getByText('Continent'));

    expect(screen.getByText('is one of')).toBeVisible();

    await userEvent.click(screen.getByText('is one of'));
  ...
  it('render the component with input type textarea', async () => {
    ...
    await userEvent.click(isOperator);
  ...
  it('render the component with input type date', async () => {
    ...
    await userEvent.type(inputElement, '12/06/2024{enter}');
  ...
  it('render the component with input type date range', async () => {
    ...
    await userEvent.click(betweenOperator);
  ...
  it('render the component with input type time', async () => {
    ...
    await userEvent.type(timeElement, '12:30');
  ...
  it('render the Hierarchical variant with  3 conditions and 1 subgroup', async () => {
    ...
    await userEvent.click(addSubGroupButton);
  ...
  it('check the next/previous close button is focussed on remove condition for Hierarchical variant', async () => {
    ...
    await userEvent.click(closeButtons[4]);
    closeButtons = document.querySelectorAll(`.${blockClass}__close-condition`);
    await userEvent.click(closeButtons[3]);
    closeButtons = document.querySelectorAll(`.${blockClass}__close-condition`);
    expect(closeButtons).toHaveLength(3);
  ...
  it('check the add/remove actions ', async () => {
    ...
    await userEvent.click(closeConditions[2]);
    ...
    await userEvent.click(closeConditions[1]);
  ...
  it('check with custom operator configuration ', async () => {
    ...
    await userEvent.click(screen.getByRole('option', { name: 'has value' }));
  ...
  it('check read only state', async () => {
    ...
    await userEvent.click(continent);
