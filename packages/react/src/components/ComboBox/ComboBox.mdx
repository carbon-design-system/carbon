  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({ story: ComboBoxStories.Default }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: ComboBoxStories.AutocompleteWithTypeahead,
        }),
    },
  ]}
/>
...
<Canvas
  of={ComboBoxStories.Controlled}
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () =>
        stackblitzPrefillConfig({ story: ComboBoxStories.Controlled }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () =>
        stackblitzPrefillConfig({ story: ComboBoxStories.AllowCustomValue }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () =>
        stackblitzPrefillConfig({ story: ComboBoxStories.withAILabel }),
    },
  ]}
/>
