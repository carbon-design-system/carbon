...
<Preview>
  <div style={{ width: '1018px', maxWidth: '100%' }}>
    <Story id="experimental-feature-flags-enable-experimental-tile-contrast-tile--clickable" />
  </div>
  <div style={{ width: '1018px', maxWidth: '100%' }}>
    <Story id="experimental-feature-flags-enable-experimental-tile-contrast-tile--expandable" />
  </div>
  <div style={{ width: '1018px', maxWidth: '100%' }}>
    <Story id="experimental-feature-flags-enable-experimental-tile-contrast-tile--multi-select" />
  </div>
  <div style={{ width: '1018px', maxWidth: '100%' }}>
    <Story id="experimental-feature-flags-enable-experimental-tile-contrast-tile--radio" />
  </div>
  <div style={{ width: '1018px', maxWidth: '100%' }}>
    <Story id="experimental-feature-flags-enable-experimental-tile-contrast-tile--selectable" />
  </div>
</Preview>
