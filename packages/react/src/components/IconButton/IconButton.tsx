...
/**
 * Represents the alignment options for an the IconButton.
 */
type IconButtonAlign =
  | 'top'
  | 'top-left'
  | 'top-right'
  | 'bottom'
...
/**
 * Represents the different kinds of the IconButton.
 */
type IconButtonKind = 'primary' | 'secondary' | 'ghost' | 'tertiary';

/**
 * Represents the size options for an the IconButton.
 */
...
export interface IconButtonProps
   ...
   */
  label: NonNullable<ReactNodeLike>;
