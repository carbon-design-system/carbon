  ...
  additionalActions={[
    {
      ...
      onClick: () => stackblitzPrefillConfig({ story: SliderStories.Default }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () =>
        stackblitzPrefillConfig({ story: SliderStories.ControlledSlider }),
    },
  ]}
/>
...
<Canvas
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () => stackblitzPrefillConfig({ story: SliderStories.Skeleton }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: SliderStories.SliderWithCustomValueLabel,
        }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: SliderStories.SliderWithHiddenInputs,
        }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () =>
        stackblitzPrefillConfig({ story: SliderStories.TwoHandleSkeleton }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () =>
        stackblitzPrefillConfig({ story: SliderStories.TwoHandleSlider }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: SliderStories.TwoHandleSliderWithHiddenInputs,
        }),
    },
  ]}
/>
