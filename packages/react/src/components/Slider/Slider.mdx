...
#### Controlled Slider with Layer:

<Canvas
  of={SliderStories.ControlledSliderWithLayer}
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () => stackblitzPrefillConfig(SliderStories.ControlledSliderWithLayer),
    },
  ]}
/>
