  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: FluidTextAreaStories.Default,
          styles: FluidTextAreaStories.default.parameters.styles,
        }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: FluidTextAreaStories.Skeleton,
          styles: FluidTextAreaStories.default.parameters.styles,
        }),
    },
  ]}
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: FluidTextAreaStories.DefaultWithToggletip,
          styles: FluidTextAreaStories.default.parameters.styles,
        }),
    },
  ]}
...
<Canvas of={FluidTextAreaStories.DefaultWithLayers} />
