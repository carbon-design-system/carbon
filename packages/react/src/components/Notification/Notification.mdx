...
<Canvas id="components-notifications-actionable--playground" />

## Inline

<Canvas id="components-notifications-inline--playground" />

## Toast

<Canvas id="components-notifications-toast--playground" />
