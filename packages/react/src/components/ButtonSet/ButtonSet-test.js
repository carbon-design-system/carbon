...
describe('ButtonSet', () => {
  ...
  describe('fluid', () => {
    ...
    it('should not render fluid inner wrapper when fluid is false', async () => {
      let container;
      await act(async () => {
        ({ container } = render(
          <ButtonSet data-testid="test">
    ...
    it('should sort buttons by kind in horizontal layout (ghost < tertiary < secondary < danger < primary)', async () => {
      let container;
      await act(async () => {
        ({ container } = render(
          <ButtonSet fluid>
