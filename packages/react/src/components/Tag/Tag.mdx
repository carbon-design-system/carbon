  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: TagStories.ReadOnly,
          styles: TagStories.default.parameters.styles,
        }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: InteractiveTagStories.Dismissible,
          styles:
            InteractiveTagStories.default.parameters.styles +
            InteractiveTagStories.default.parameters.interactiveTagStyles,
        }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: InteractiveTagStories.Selectable,
          styles:
            InteractiveTagStories.default.parameters.styles +
            InteractiveTagStories.default.parameters.interactiveTagStyles,
        }),
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: InteractiveTagStories.Operational,
          styles:
            InteractiveTagStories.default.parameters.styles +
            InteractiveTagStories.default.parameters.interactiveTagStyles,
        }),
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: TagStories.withAILabel,
          styles:
            TagStories.default.parameters.styles +
            TagStories.default.parameters.aiLabelStyles,
        }),
    },
  ]}
/>
