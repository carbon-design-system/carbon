...
export default class DatePicker extends Component {
  ...
  componentDidMount() {
    ...
    if (datePickerType === 'single' || datePickerType === 'range') {
      ...
      this.toInputField = React.createRef();
  ...
  addKeyboardEvents = (cal) => {
    ...
    initArrowDownListener(this.inputField.current);
    initArrowDownListener(this.toInputField.current);
  };
