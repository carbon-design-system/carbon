...
describe('DatePicker', () => {
  it('should throw for interactive content in DatePickerInput labelText', () => {
    ...
    try {
      ...
      expect(errorSpy).toHaveBeenCalledWith(
        expect.stringContaining(
          'Error: The DatePickerInput component `labelText` prop must have no interactive content'
        )
      );
    } finally {
      spy.mockRestore();
