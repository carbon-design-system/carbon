...
as a child at the same time. To prevent this, we have added funtionality to support both designs and both use cases. Please see [Persistent Search](#persistent-search) docs below. 
