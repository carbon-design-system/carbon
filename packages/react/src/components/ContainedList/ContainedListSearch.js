...
const ContainedListSearch = React.forwardRef(function ContainedListSearch(
  {
    autoComplete = 'off',
    className,
...
ContainedListSearch.displayName = 'ContainedListSearch';
ContainedListSearch.propTypes = {
  /**
...
export default ContainedListSearch;
