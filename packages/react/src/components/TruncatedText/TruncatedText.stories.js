...
export default {
  ...
  decorators: [
    (Story) => (
      <div className="sb-truncated-text-story">
        <Story />
      </div>
    ),
  ],
...
export const WithTooltip = (args) => <TruncatedText {...args} />;
WithTooltip.args = { ...defaultArgs };
WithTooltip.storyName = 'With tooltip';

export const WithExpand = (args) => <TruncatedText {...args} />;
WithExpand.args = { ...defaultArgs, type: 'expand' };
WithExpand.storyName = 'With expand';
