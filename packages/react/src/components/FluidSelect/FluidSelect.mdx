...
import * as FluidSelectStories from './FluidSelect.stories';
...
<Canvas
  of={FluidSelectStories.Default}
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () =>
        stackblitzPrefillConfig({
          story: FluidSelectStories.Default,
          styles: FluidSelectStories.default.parameters.styles,
        }),
    },
  ]}
/>
...
<Canvas
  of={FluidSelectStories.withAILabel}
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () =>
        stackblitzPrefillConfig({
          story: FluidSelectStories.withAILabel,
          styles: FluidSelectStories.default.parameters.styles,
        }),
    },
  ]}
...
<Canvas
  of={FluidSelectStories.Skeleton}
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () =>
        stackblitzPrefillConfig({
          story: FluidSelectStories.Skeleton,
          styles: FluidSelectStories.default.parameters.styles,
        }),
    },
  ]}
