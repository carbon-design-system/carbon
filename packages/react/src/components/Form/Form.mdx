...
import formDemoSrc from './stories/form-demo.js?raw';
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: FormStories.Default,
          customImports: ["import FormDemo from './stories/form-demo';"],
          additionalFiles: { 'src/stories/form-demo.tsx': formDemoSrc },
        }),
    },
  ]}
/>
