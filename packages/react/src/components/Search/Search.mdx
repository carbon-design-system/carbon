...
#### Expandable With Layer: 

<Canvas
  of={SearchStories.ExpandableWithLayer}
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () => stackblitzPrefillConfig(SearchStories.ExpandableWithLayer),
    },
  ]}
/>
...
#### With Layer: 
<Canvas
  of={SearchStories._WithLayer}
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () => stackblitzPrefillConfig(SearchStories._WithLayer),
    },
  ]}
/>
