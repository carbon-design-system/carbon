    ...
    additionalActions={[
      {
        ...
        onClick: () =>
          stackblitzPrefillConfig({ story: OrderedListStories.Default }),
      },
    ]}
  />
</div>
    ...
    additionalActions={[
      {
        ...
        onClick: () =>
          stackblitzPrefillConfig({
            story: OrderedListStories.NativeListStyles,
          }),
      },
    ]}
  />
    ...
    additionalActions={[
      {
        title: 'Open in Stackblitz',
        onClick: () =>
          stackblitzPrefillConfig({ story: OrderedListStories.Nested }),
      },
    ]}
  />
</div>
