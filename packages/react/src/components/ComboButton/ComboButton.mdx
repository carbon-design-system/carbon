  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({ story: ComboButtonStories.Default }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () =>
        stackblitzPrefillConfig({ story: ComboButtonStories.WithIcons }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () =>
        stackblitzPrefillConfig({ story: ComboButtonStories.WithDanger }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: ComboButtonStories.ExperimentalAutoAlign,
        }),
    },
  ]}
/>
