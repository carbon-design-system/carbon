  ...
  additionalActions={[
    {
      ...
      onClick: () => stackblitzPrefillConfig({ story: LayerStories.Default }),
    },
  ]}
/>
...
the `withBackground` prop, it automatically sets a background color using the
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () =>
        stackblitzPrefillConfig({ story: LayerStories.withBackground }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () =>
        stackblitzPrefillConfig({ story: LayerStories.CustomLevel }),
    },
  ]}
/>
