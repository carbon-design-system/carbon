...
<InlineNotification kind="info">
  This example documentation is from the component Documentation templates can
  be found
</InlineNotification>
[Source
code](https://github.com/carbon-design-system/carbon/tree/main/packages/react/src/components/Accordion)
&nbsp;|&nbsp; [Usage
guidelines](https://www.carbondesignsystem.com/components/accordion/usage)
&nbsp;|&nbsp;
