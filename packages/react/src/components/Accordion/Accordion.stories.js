...
export const NestedAccordion = () => (
  <Accordion>
    <AccordionItem title="Section 1 title">
      <Accordion>
        <AccordionItem title="Section 1.1 title">
          <Accordion>
            <AccordionItem title="Section 1.1.1 title">
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          ...
          <Accordion>
            <AccordionItem title="Section 1.1.2 title">
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
                enim ad minim veniam, quis nostrud exercitation ullamco laboris
    ...
    <AccordionItem title="Section 3 title">
      <Accordion>
        <AccordionItem title="Section 3.1 title">
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim
            ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
        ...
        <AccordionItem title="Section 3.2 title">
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim
            ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
