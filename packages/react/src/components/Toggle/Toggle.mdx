  ...
  additionalActions={[
    {
      ...
      onClick: () => stackblitzPrefillConfig({ story: ToggleStories.Default }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () =>
        stackblitzPrefillConfig({ story: ToggleStories.SmallToggle }),
    },
  ]}
/>
...
<Canvas
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () => stackblitzPrefillConfig({ story: ToggleStories.Skeleton }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () =>
        stackblitzPrefillConfig({ story: ToggleStories.WithAccessibleLabels }),
    },
  ]}
/>
