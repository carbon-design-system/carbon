...
describe('FluidNumberInput', () => {
  describe('renders as expected - Component API', () => {
    it('should render as expected', () => {
      const { container } = render(
        <FeatureFlags flags={{ 'enable-v11-release': true }}>
          <FluidNumberInput id="input-1" labelText="FluidNumberInput label" />
        </FeatureFlags>
      );
    ...
    it('should spread extra props onto the input element', () => {
      render(
        <FluidNumberInput
          data-testid="test-id"
          id="input-1"
          labelText="FluidNumberInput label"
        />
      );
    ...
    it('should respect invalid prop', () => {
      const { container } = render(
        <FluidNumberInput id="input-1" labelText="FluidNumberInput" invalid />
      );
