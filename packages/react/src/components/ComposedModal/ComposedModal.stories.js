...
export const WithScrollingContentMaxHeader = () => {
  const [open, setOpen] = useState(true);
  ...
  return (
    <>
      ...
      <ComposedModal open={open} onClose={() => setOpen(false)}>
        <ModalHeader
          label="Account resources"
          title="Add a custom domainAdd a custom domainAdd a custom  a custom domainAdd a custom domainAdd a custom domainAdd a custom domainAdd a custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd custom domainAdd   custom domainAdd a custom domainAdd a custom domainAdd a custom domainAdd a custom domainAdd a custom domainAdd a custom domainAdd a custom domainAdd a custom domainAdd a custom domain"
        />
        <ModalBody hasScrollingContent>
          <p style={{ marginBottom: '1rem' }}>
            Custom domains direct requests for your apps in this Cloud Foundry
