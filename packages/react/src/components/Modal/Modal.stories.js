...
export const ComposedModalScrollBugFix = () => {
  // --- Inline Styles ---
  const styles = {
  ...
  return (
    <ComposedModal open={open} size="md">
        ...
        <ContainedList
          ...
          label={
            <>
              ...
              <span
                style={{ marginLeft: '1rem', marginBottom: '2.7rem' }}></span>
            </>
          }>
          <Button />
          <ContainedListItem
            style={{ marginBottom: '0.7rem' }}
            id="startTime"></ContainedListItem>

          <ContainedListItem
            style={{ marginBottom: '0.7rem' }}
            id="endTime"></ContainedListItem>

          <ContainedListItem style={{ marginBottom: '0.7rem' }}>
            <span style={{ display: 'inline-block', marginBottom: '0.65rem' }}>
              Blockout Targets
            </span>
          </ContainedListItem>

          <ContainedListItem style={styles.BlockoutUpdate_Margin_Gap}>
            <span style={{ display: 'inline-block', marginBottom: '0.65rem' }}>
              Events
            </span>
          </ContainedListItem>
...
// remove this test story before merging
export const ModalScrollBugFix = () => {
  const styles = {
    BlockoutUpdate_ListItem: {
      display: 'flex',
      alignItems: 'center',
