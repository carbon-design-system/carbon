...
Instead of wrapping your component with `ModalPresence`, you can also use the
higher-order function `withModalPresence`. This will automatically wrap your
component and handle the props and types for you:
