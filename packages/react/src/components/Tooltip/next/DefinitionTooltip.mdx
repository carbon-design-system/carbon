...
The `DefinitionTooltip` is made up of two parts: a term and the tooltip
itself. You can customize the contents of the tooltip through the `definition`
prop. You can customize the term by providing your own `children` to this
component.

<Canvas>
  <Story id="components-definitiontooltip--default" />
</Canvas>
