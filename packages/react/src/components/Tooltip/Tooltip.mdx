  ...
  additionalActions={[
    {
      ...
      onClick: () => stackblitzPrefillConfig({ story: TooltipStories.Default }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () =>
        stackblitzPrefillConfig({ story: TooltipStories.Alignment }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () =>
        stackblitzPrefillConfig({ story: TooltipStories.Duration }),
    },
  ]}
/>
