...
are `field`, `small`, `large`, `xl` and `default`. If no `size` is specified, it renders as
`default`.

 <Button>Submit</Button> <Button size="field">Submit</Button> <Button size="small">Submit</Button> <Button size="large">Submit</Button> <Button size="xl">Submit</Button>
