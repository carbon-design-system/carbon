  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: ButtonStories.Default,
          customImports: [getIconFromStringImport],
          customFunctionDefs: [getIconFromStringDef],
        }),
    },
  ]}
/>
...
```jsx
<div style={{ '--cds-button-radius': '0' /* $border-radius-00 */ }}>
  <Button>Flush</Button>
</div>
```
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          story: ButtonStories.IconButton,
          customImports: [getIconFromStringImport],
          customFunctionDefs: [getIconFromStringDef],
        }),
    },
...
<Canvas
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () => stackblitzPrefillConfig({ story: ButtonStories.Skeleton }),
    },
  ]}
/>
