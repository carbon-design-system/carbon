...
<Unstyled>
  <div style={{ display: 'flex', gap: '1rem' }}>
    <Button kind="danger">Secondary</Button>
    <Button kind="danger--tertiary">Tertiary </Button>
    <Button kind="danger--ghost">Ghost</Button>
  </div>
</Unstyled>
...
this seems to not work as icons inside buttons are always 16px. should we remove this?

<Unstyled>
  <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
    <Button
      renderIcon={(props) => <Add size={24} {...props} />}
      iconDescription="Add">Add</Button>
    <Button
