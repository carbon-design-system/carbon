...
<Button renderIcon={Add} iconDescription="Add">
  Add
</Button> <Button renderIcon={TrashCan} kind="danger" iconDescription="Delete">
  Delete
</Button>

```jsx
<Button renderIcon={Add} iconDescription="Add">Add</Button>
<Button renderIcon={TrashCan} kind="danger"  iconDescription="Delete">Delete</Button>
```
...
<Button hasIconOnly renderIcon={Add} iconDescription="Add" /> <Button
  hasIconOnly
  renderIcon={Add}
  iconDescription="Add"
