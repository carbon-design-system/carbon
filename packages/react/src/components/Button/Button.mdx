...
import {
  ...
  stackblitzPrefillConfigDemo,
} from '../../../previewer/codePreviewer';
import { ButtonSecondary } from './demo/ButtonSecondary';
...
<Canvas
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () => stackblitzPrefillConfigDemo(ButtonSecondary),
    },
  ]}
/>
...
<Canvas
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () => stackblitzPrefillConfig(ButtonStories.IconButton, ['Add']),
    },
  ]}
/>
