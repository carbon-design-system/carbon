import { ArgTypes, Meta, Canvas, Unstyled } from '@storybook/addon-docs/blocks';
import Select from './';
  ...
  additionalActions={[
    {
      ...
      onClick: () => stackblitzPrefillConfig({ story: SelectStories.Default }),
    },
  ]}
/>
...
<Canvas
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () => stackblitzPrefillConfig({ story: SelectStories.Inline }),
    },
  ]}
/>
...
<Canvas
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () => stackblitzPrefillConfig({ story: SelectStories.Skeleton }),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () =>
        stackblitzPrefillConfig({ story: SelectStories.withAILabel }),
    },
  ]}
/>
