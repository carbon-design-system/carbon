(function (global, factory) {
  ...
  exports.default = function (ToMix) {
    ...
    var InitComponentByEvent = function (_ToMix) {
      (0, _inherits3.default)(InitComponentByEvent, _ToMix);

      function InitComponentByEvent() {
        (0, _classCallCheck3.default)(this, InitComponentByEvent);
        return (0, _possibleConstructorReturn3.default)(this, (InitComponentByEvent.__proto__ || (0, _getPrototypeOf2.default)(InitComponentByEvent)).apply(this, arguments));
      }

      (0, _createClass3.default)(InitComponentByEvent, null, [{
        key: 'init',
