...
test.describe('@avt FluidTextInput', () => {
  test('@avt-default-state', async ({ page }) => {
    await visitStory(page, {
      ...
      id: 'preview-fluid-components-unstable-fluidtextinput--default',
      globals: {
        theme: 'white',
      },
    });
  ...
  test('@avt-advanced-states password input', async ({ page }) => {
    await visitStory(page, {
      component: 'FluidTextInput',
      id: 'preview-fluid-components-unstable-fluidpasswordinput--default',
      globals: {
        theme: 'white',
      },
    });
  ...
  test('@avt-advanced-states with tooltip', async ({ page }) => {
    await visitStory(page, {
      component: 'FluidTextInput',
      id: 'preview-fluid-components-unstable-fluidtextinput--default-with-tooltip',
      globals: {
        theme: 'white',
      },
    });
  ...
  test('@avt-advanced-states skeleton', async ({ page }) => {
    await visitStory(page, {
      component: 'FluidTextInput',
      id: 'preview-fluid-components-unstable-fluidtextinput--skeleton',
      globals: {
        theme: 'white',
      },
    });
