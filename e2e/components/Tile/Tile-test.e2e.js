  ...
  themes.forEach((theme) => {
    test.describe(theme, () => {
      ...
      test('feature flags clickable @vrt', async ({ page }) => {
        await snapshotStory(page, {
          component: 'Tile',
          id: 'components-composedmodal-feature-flags-tile--clickable',
          theme,
        });
      });
      ...
      test('feature flags clickable with layer @vrt', async ({ page }) => {
        await snapshotStory(page, {
          component: 'Tile',
          id: 'components-composedmodal-feature-flags-tile--clickable-with-layer',
          theme,
        });
      });
      ...
      test('feature flags selectable @vrt', async ({ page }) => {
        await snapshotStory(page, {
          component: 'Tile',
          id: 'components-composedmodal-feature-flags-tile--selectable',
          theme,
        });
      });
      ...
      test('feature flags multi select @vrt', async ({ page }) => {
        await snapshotStory(page, {
          component: 'Tile',
          id: 'components-composedmodal-feature-flags-tile--multi-select',
          theme,
        });
      });
      ...
      test('feature flags radio @vrt', async ({ page }) => {
        await snapshotStory(page, {
          component: 'Tile',
          id: 'components-composedmodal-feature-flags-tile--radio',
          theme,
        });
      });
      ...
      test('feature flags radio with layer @vrt', async ({ page }) => {
        await snapshotStory(page, {
          component: 'Tile',
          id: 'components-composedmodal-feature-flags-tile--radio-with-layer',
          theme,
        });
      });
      ...
      test('feature flags expandable @vrt', async ({ page }) => {
        await snapshotStory(page, {
          component: 'Tile',
          id: 'components-composedmodal-feature-flags-tile--expandable',
          theme,
        });
      });
      ...
      test('feature flags expandable with interactive @vrt', async ({
        ...
        await snapshotStory(page, {
          component: 'Tile',
          id: 'components-composedmodal-feature-flags-tile--expandable-with-interactive',
          theme,
        });
      });
      ...
      test('feature flags expandable with layer @vrt', async ({ page }) => {
        await snapshotStory(page, {
          component: 'Tile',
          id: 'components-composedmodal-feature-flags-tile--expandable-with-layer',
          theme,
        });
      });
    });
