...
test.describe('@avt FluidTextArea', () => {
  test('@avt-default-state', async ({ page }) => {
    await visitStory(page, {
      ...
      id: 'preview-fluid-components-preview-fluidtextarea--default',
      globals: {
        theme: 'white',
      },
    });
  ...
  test('@avt-advanced-states default-with-layers', async ({ page }) => {
    await visitStory(page, {
      component: 'FluidTextArea',
      id: 'preview-fluid-components-preview-fluidtextarea--default-with-layers',
      globals: {
        theme: 'white',
      },
    });
  ...
  test('@avt-advanced-states default-with-tooltip', async ({ page }) => {
    await visitStory(page, {
      component: 'FluidTextArea',
      id: 'preview-fluid-components-preview-fluidtextarea--default-with-tooltip',
      globals: {
        theme: 'white',
      },
    });
  ...
  test('@avt-advanced-states skeleton', async ({ page }) => {
    await visitStory(page, {
      component: 'FluidTextArea',
      id: 'preview-fluid-components-preview-fluidtextarea--skeleton',
      globals: {
        theme: 'white',
      },
    });
